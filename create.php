...
<div class=" col-sm-6">
          <input type="date" class="form-control" name="bod" id="datepicker" value="<?php echo $bod; ?>">
        </div>
      ...
      <div class="row mb-3">
        ...
        <div class="offset-sm-2 col-sm-2 d-grid">
          <button type="cancel" class="btn btn-outline-primary" href="/index.php">Cancel</button>
        </div>
      </div>
    </form>
